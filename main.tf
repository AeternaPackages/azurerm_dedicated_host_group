...
module "dedicated_host_groups" {
  source                = "git::https://github.com/AeternaModules/azurerm_dedicated_host_group.git?ref=v4.80.0"
  dedicated_host_groups = local.dedicated_host_groups
}

module "dedicated_hosts" {
  source          = "git::https://github.com/AeternaModules/azurerm_dedicated_host.git?ref=v4.80.0"
