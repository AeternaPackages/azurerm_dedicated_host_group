...
module "dedicated_host_groups" {
  source                = "git::https://github.com/AeternaModules/azurerm_dedicated_host_group.git?ref=v5.0.1"
  dedicated_host_groups = local.dedicated_host_groups
}

module "dedicated_hosts" {
  source          = "git::https://github.com/AeternaModules/azurerm_dedicated_host.git?ref=v5.0.1"
